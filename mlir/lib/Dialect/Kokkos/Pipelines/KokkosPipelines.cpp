...
void mlir::kokkos::registerKokkosPipelines() {
  ...
  PassPipelineRegistration<>(
      "sparse-compiler-kokkos-post-ad",
      "The pipeline for taking differentiated IR in memref/SCF dialects"
      " and lowering it to Kokkos dialects (compatible with Kokkos emitter)",
      buildSparseKokkosCompilerPostAD);
